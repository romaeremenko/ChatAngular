...
export class RedirectToChatService {
  ...
  public redirectTo(resp: UserResponce, loginField: string, passwordField: string, roomName: string) {
    this.сhatService.user.info = resp;
    this.localStorageService.setUserLoggedIn({loginField, passwordField});
